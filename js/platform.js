window.Platforrm = {
    ...
    getProducts: function () {
        $.ajax({
            url: Platforrm.API_BASE_URL + "/products",
            method: "GET"
        }).done(function (response) {
            console.log(response);
            Platforrm.displayProducts(response.content);
        })
    },
    ...
    displayProducts: function (products) {
        ...
        products.forEach(products => allProductsHtml += Platforrm.getProductHtml(product));
